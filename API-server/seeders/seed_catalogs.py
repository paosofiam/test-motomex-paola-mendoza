...
Inserta monedas, intenciones_de_compra_de_leads, chat_statuses y estados con sus ids exactos.
...
def main() -> None:
    ...
    try:
        ...
        estados.seed(db)
        print(">> Catálogos del sistema sembrados: monedas, intenciones_de_compra_de_leads, chat_statuses, estados.")
    finally:
        db.close()
